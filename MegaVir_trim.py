# Adapted from shu251/qc-trim https://github.com/shu251/qc-trim
...
rule trimmomatic_pe:
 ...
 #   r2 = SCRATCH_PROJ + "/trimmed/{sample}_2_trim.fastq.gz",
  ...
  params:
    trimmer = ["ILLUMINACLIP:{}:2:30:1".format(ADAPTERS), "LEADING:8", "TRAILING:8", "SLIDINGWINDOW:10:15", "MINLEN:36", "-threads 16"],
    extra = ""
  wrapper:
